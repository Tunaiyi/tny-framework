...
public enum BasicsResultCode implements ResultCode {
	...
	BasicsResultCode(int code, String message) {
		this(code, message, ResultCodeType.GENERAL);
	}

	BasicsResultCode(int code, String message, ResultCodeType type) {
		this.code = code;

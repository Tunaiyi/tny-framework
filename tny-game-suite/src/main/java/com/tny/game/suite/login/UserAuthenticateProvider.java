...
public abstract class UserAuthenticateProvider extends GameAuthenticateProvider<Long> {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserAuthenticateProvider.class);
    ...
    protected Certificate<Long> checkUserLogin(Tunnel<Long> tunnel, Message<Long> message, boolean relogin) throws DispatchException {

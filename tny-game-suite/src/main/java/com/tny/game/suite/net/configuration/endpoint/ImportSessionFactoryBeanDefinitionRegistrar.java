 ...
 * <p>
 */
public class ImportSessionFactoryBeanDefinitionRegistrar extends SuiteBeanDefinitionRegistrar {
    ...
    protected void loadBeanDefinition(String name, BeanDefinitionRegistry registry) {
        ...
        String factoryClassName = environment.getProperty(key(keyHead, CLASS_NODE), CommonSessionFactory.class.getName());

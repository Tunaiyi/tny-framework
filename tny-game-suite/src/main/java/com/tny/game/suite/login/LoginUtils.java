...
public class LoginUtils {
    ...
    public static boolean checkWebSign(ServerType serverType, SortedMap<String, String> param) {
    ...
    public static String webSign(ServerType serverType, SortedMap<String, String> param) {
    ...
    public static String ticket2MD5(GameTicket ticket, String key) {
        ...
        ticketBuffer.append(ticket.getPfAccount());
    ...
    public static void setTicketMD5(GameTicket ticket, String key) {
        ticket.setTicket(ticket2MD5(ticket, key));
    }

...
public class ServerAuthenticateProvider extends GameAuthenticateProvider<Integer> {

    @Resource
    private ServerTicketMaker maker;

    @Override
    public Certificate<Integer> validate(Tunnel<Integer> tunnel, Message<Integer> message) throws DispatchException {

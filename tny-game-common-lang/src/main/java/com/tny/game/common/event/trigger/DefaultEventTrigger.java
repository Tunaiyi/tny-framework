 ...
 */
class DefaultEventTrigger<L, S> implements EventTrigger<L, S> {

    public static final Logger LOGGER = LoggerFactory.getLogger(DefaultEventTrigger.class);
    ...
    public DefaultEventTrigger(Class<L> listenerClass, boolean global, Supplier<List<L>> listCreator) {
    ...
    @SafeVarargs
    public DefaultEventTrigger(Class<L> listenerClass, boolean global, Supplier<List<L>> listCreator, L... listeners) {
    ...
    @SafeVarargs
    public DefaultEventTrigger(Class<L> listenerClass, boolean global, L... listeners) {
        this(listenerClass, global, ArrayList::new, listeners);
    }

    public DefaultEventTrigger(Class<L> listenerClass, boolean global, Collection<? extends L> listeners) {
        this(listenerClass, global, ArrayList::new, listeners);
    }
    ...
    @Override
    public void trigger(BiConsumer<L, S> invoker, S source) {
        this.doTrigger(invoker, (i, listener) -> i.accept(listener, source));
    }

    @Override
    public <E extends Event<S>> void trigger(ComEventInvoker<L, E> invoker, E event) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, event));
    }

    @Override
    public <A> void trigger(P1EventInvoker<L, S, A> invoker, S source, A a) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a));
    }

    @Override
    public <A1, A2> void trigger(P2EventInvoker<L, S, A1, A2> invoker, S source, A1 a1, A2 a2) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a1, a2));
    }

    @Override
    public <A1, A2, A3> void trigger(P3EventInvoker<L, S, A1, A2, A3> invoker, S source, A1 a1, A2 a2, A3 a3) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a1, a2, a3));
    }

    @Override
    public <A1, A2, A3, A4> void trigger(P4EventInvoker<L, S, A1, A2, A3, A4> invoker, S source, A1 a1, A2 a2, A3 a3, A4 a4) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a1, a2, a3, a4));
    }

    @Override
    public <A1, A2, A3, A4, A5> void trigger(P5EventInvoker<L, S, A1, A2, A3, A4, A5> invoker, S source, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) {

...
public final class Events {
    ...
    public static <L, E extends EventNotice<?>> GeneralBindEvent<L, E> ofGeneral(Class<L> clazz, GeneralEventInvoker<L, E> fn,
            Supplier<Collection<GeneralEventDelegate<E>>> factory, boolean global) {
        return new GeneralBindEvent<>(clazz, fn, factory, global);
    }

    public static <L, E extends EventNotice<?>> GeneralBindEvent<L, E> ofGeneral(Class<L> clazz, GeneralEventInvoker<L, E> fn,
            Supplier<Collection<GeneralEventDelegate<E>>> listeners) {
    ...
    public static <L, S> VoidBindEvent<L, S> ofEvent(Class<L> clazz, VoidEventInvoker<L, S> fn, Supplier<Collection<VoidEventDelegate<S>>> factory,
            boolean global) {
    ...
    public static <L, S, A> A1BindEvent<L, S, A> ofEvent(Class<L> clazz, Arg1EventInvoker<L, S, A> fn,
            Supplier<Collection<Arg1EventDelegate<S, A>>> factory, boolean global) {
        return new A1BindEvent<>(clazz, fn, factory, global);
    }

    public static <L, S, A> A1BindEvent<L, S, A> ofEvent(Class<L> clazz, Arg1EventInvoker<L, S, A> fn,
            Supplier<Collection<Arg1EventDelegate<S, A>>> factory) {
    ...
    public static <L, S, A1, A2> A2BindEvent<L, S, A1, A2> ofEvent(Class<L> clazz, Args2EventInvoker<L, S, A1, A2> fn,
            Supplier<Collection<Args2EventDelegate<S, A1, A2>>> factory) {
    ...
    public static <L, S, A1, A2, A3> A3BindEvent<L, S, A1, A2, A3> ofEvent(Class<L> clazz, Args3EventInvoker<L, S, A1, A2, A3> fn,
            Supplier<Collection<Args3EventDelegate<S, A1, A2, A3>>> factory) {
    ...
    public static <L, S, A1, A2, A3, A4> A4BindEvent<L, S, A1, A2, A3, A4> ofEvent(Class<L> clazz, Args4EventInvoker<L, S, A1, A2, A3, A4> fn,
            Supplier<Collection<Args4EventDelegate<S, A1, A2, A3, A4>>> factory) {
    ...
    public static <L, S, A1, A2, A3, A4, A5> A5BindEvent<L, S, A1, A2, A3, A4, A5> ofEvent(Class<L> clazz,
            Args5EventInvoker<L, S, A1, A2, A3, A4, A5> fn, Supplier<Collection<Args5EventDelegate<S, A1, A2, A3, A4, A5>>> factory, boolean global) {
        return new A5BindEvent<>(clazz, fn, factory, global);
    }

    public static <L, S, A1, A2, A3, A4, A5> A5BindEvent<L, S, A1, A2, A3, A4, A5> ofEvent(Class<L> clazz,
            Args5EventInvoker<L, S, A1, A2, A3, A4, A5> fn, Supplier<Collection<Args5EventDelegate<S, A1, A2, A3, A4, A5>>> factory) {
    ...
    public static <S> VoidEvent<S> ofVoidEvent(Supplier<Collection<VoidEventDelegate<S>>> factory) {
        return new VoidEvent<>(factory);
    }

    public static <S, A> A1Event<S, A> ofA1Event(Supplier<Collection<Arg1EventDelegate<S, A>>> factory) {
        return new A1Event<>(factory);
    }

    public static <S, A1, A2> A2Event<S, A1, A2> ofA2Event(Supplier<Collection<Args2EventDelegate<S, A1, A2>>> factory) {
        return new A2Event<>(factory);
    }

    public static <S, A1, A2, A3> A3Event<S, A1, A2, A3> ofA3Event(Supplier<Collection<Args3EventDelegate<S, A1, A2, A3>>> factory) {
        return new A3Event<>(factory);
    }

    public static <S, A1, A2, A3, A4> A4Event<S, A1, A2, A3, A4> ofA4Event(Supplier<Collection<Args4EventDelegate<S, A1, A2, A3, A4>>> factory) {
        return new A4Event<>(factory);
    }

    public static <S, A1, A2, A3, A4, A5> A5Event<S, A1, A2, A3, A4, A5> ofA5Event(
            Supplier<Collection<Args5EventDelegate<S, A1, A2, A3, A4, A5>>> factory) {

...
public class Asserts {
	...
	public interface ExceptionWithCauseCreator<E extends RuntimeException> {

		E create(String message, Throwable e);

	}

	public static RuntimeException uncheck(Exception exception) {
		return new CommonRuntimeException(exception);
	}

	public static void throwUncheck(Exception exception) {
	...
	public static void throwWith(ExceptionWithCauseCreator<? extends RuntimeException> creator, Throwable e, String errorMessageTemplate,
			Object... errorMessageArgs) {
		throw creator.create(format(errorMessageTemplate, errorMessageArgs), e);
	}

	public static void checkInstanceOf(Object object, Class<?> clazz) {
	...
	public static void hasLength(String text, String errorMessageTemplate, Object... errorMessageArgs) {
		if (!StringUtils.isNotBlank(text)) {
			throw new IllegalArgumentException(format(errorMessageTemplate, errorMessageArgs));
		}
	}

	public static void hasLength(String text, Function<String, RuntimeException> exCreator, String message) {
		if (!StringUtils.isNotBlank(text)) {
			throw exCreator.apply(message);
		}
	}

	public static void hasLength(String text, Function<String, RuntimeException> exCreator, String errorMessageTemplate,
			Object... errorMessageArgs) {
		if (!StringUtils.isNotBlank(text)) {
			throw exCreator.apply(format(errorMessageTemplate, errorMessageArgs));
		}
	}

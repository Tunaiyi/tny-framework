...
class DefaultEventFirer<L, S> implements EventFirer<L, S> {
    ...
    @Override
    public <A> void fire(Arg1EventInvoker<L, S, A> invoker, S source, A a) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a));
    }

    @Override
    public <A1, A2> void fire(Args2EventInvoker<L, S, A1, A2> invoker, S source, A1 a1, A2 a2) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a1, a2));
    }

    @Override
    public <A1, A2, A3> void fire(Args3EventInvoker<L, S, A1, A2, A3> invoker, S source, A1 a1, A2 a2, A3 a3) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a1, a2, a3));
    }

    @Override
    public <A1, A2, A3, A4> void fire(Args4EventInvoker<L, S, A1, A2, A3, A4> invoker, S source, A1 a1, A2 a2, A3 a3, A4 a4) {
        this.doTrigger(invoker, (i, listener) -> i.invoke(listener, source, a1, a2, a3, a4));
    }

    @Override
    public <A1, A2, A3, A4, A5> void fire(Args5EventInvoker<L, S, A1, A2, A3, A4, A5> invoker, S source, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) {

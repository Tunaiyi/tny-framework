...
public class EventTriggerDispatcherTest {
    ...
    public void testAddListener() {
        ...
        this.context.checking(new Expectations() {{
            oneOf(listener).handleCreate(EventTriggerDispatcherTest.this.SOURCE);
            never(listener).handleUpgrade(EventTriggerDispatcherTest.this.SOURCE, null);
        }});
        this.CREATE_EVENT.notify(this.SOURCE);
        this.context.assertIsSatisfied();

        this.context.checking(new Expectations() {{
            never(listener).handleCreate(EventTriggerDispatcherTest.this.SOURCE);
            oneOf(listener).handleUpgrade(EventTriggerDispatcherTest.this.SOURCE, EventTriggerDispatcherTest.this.level);
        }});
        ...
        this.context.checking(new Expectations() {{
            never(listener).handleCreate(EventTriggerDispatcherTest.this.SOURCE);
            never(listener).handleUpgrade(EventTriggerDispatcherTest.this.SOURCE, EventTriggerDispatcherTest.this.level);
        }});
        this.UPGRADE_EVENT.notify(this.SOURCE, this.level);
        this.context.assertIsSatisfied();

...
public class CRC64 {
    ...
    // crc64算法
    public static final long crc64Long(byte[]... buffers) {
        long crc = INITIALCRC;
    ...
    // crc64算法
    public static final long crc64Long(long crc, byte[] buffer) {
        return crc64Long(crc, buffer, 0, buffer.length);
    }

    // crc64算法
    public static final long crc64Long(long crc, byte[] buffer, int from, int length) {

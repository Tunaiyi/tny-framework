...
public class GeneralPipe<UID> implements NetPipe<UID> {
    ...
    private final RelayPacketTransmitter transmitter;
    ...
    public GeneralPipe(RelayPacketTransmitter transmitter, NetBootstrapContext<UID> bootstrapContext) {
    ...
    @Override
    public RelayPacketTransmitter getTransmitter() {
        return this.transmitter;
    }

    protected void onClose() {
        RelayPacketTransmitter transporter = this.transmitter;

...
public class CommonServerUnitSetting extends CommonNetUnitSetting implements ServerUnitSetting {

    private Collection<InetSocketAddress> bindAddresses;

    public CommonServerUnitSetting() {
    }

    public CommonServerUnitSetting(AppContext appContext) {
        super(appContext);
    }
    ...
    public CommonServerUnitSetting setBindAddresses(Collection<InetSocketAddress> bindAddresses) {

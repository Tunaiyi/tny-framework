...
public class NetLogger {
	...
	public static final ProcessWatcher NET_TRACE_ALL_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_all_receive_send", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_INPUT_ALL = ProcessWatcher
			.of(MessageCommand.class + ".track_input-all", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_DECODE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_input-decode", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_INPUT_READ_TO_TUNNEL_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_input-read_to_tunnel", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_INPUT_TUNNEL_TO_EXECUTE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_input-tunnel_to_execute", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_INPUT_BOX_PROCESS_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_input-box_process", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_INPUT_EXECUTE_COMMAND_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_input-execute_command", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_OUTPUT_WRITTEN_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_output-all", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_ENCODE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_output-encode", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher NET_TRACE_OUTPUT_WRITE_TO_ENCODE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".track_output-write_to_encode", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_GET_CONTROLLER_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke-get_controller", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_CHECK_AUTHENTICATE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke-check_authenticate", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_CHECK_INVOKABLE_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke-check_invokable", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_BEFORE_PLUGINS_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke-before_plugins", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_INVOKING_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke-invoking", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_INVOKE_AFTER_PLUGINS_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_invoke-after_plugins", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

	public static final ProcessWatcher MESSAGE_EXE_HANDLE_RESULT_WATCHER = ProcessWatcher
			.of(MessageCommand.class + ".command_exe_handle_result", TrackPrintOption.CLOSE);//.schedule(15, TimeUnit.SECONDS);

...
public interface SessionHolder {
     ...
     * @param content   消息内容
     */
    <U> void send2User(String userGroup, U uid, MessageContent<U> content);
     ...
     * @param content   消息内容
     */
    <U> void send2Users(String userGroup, Collection<U> uidColl, MessageContent<U> content);
     ...
     * @param content    消息内容
     */
    <U> void send2Users(String userGroup, Stream<U> uidsStream, MessageContent<U> content);

    /**
     * 发送给所有在线的用户 <br>
     */
    <U> void send2AllOnline(String userGroup, MessageContent<U> content);

...
public class CodecConstants {
    ...
    public static final int PAYLOAD_LENGTH_BYTES_SIZE = 2;
    ...
    public static final byte DATA_PACK_OPTION_PONG = (byte)(1 << 1);
    // public static final byte OPTION_COMPRESS = (byte) (1 << 2); // 选项(是否有压缩)
    public static final byte PACKET_OPTION_VERIFY = (byte)(1 << 2); // 选项(是否有校验)
    public static final byte PACKET_OPTION_ENCRYPT = (byte)(1 << 3); // 选项(是否有加密)
    public static final byte PACKET_OPTION_WASTE_BYTES = (byte)(1 << 4); // 选项(是否有加密)
    ...
    public static final byte MESSAGE_HEAD_OPTION_EXIST_BODY = (byte)(1 << MESSAGE_HEAD_OPTION_EXIST_BODY_SHIFT); // 是否请求数据
    ...
    public static final byte MESSAGE_HEAD_OPTION_LINE_MIN_VALUE = (byte)0; // line 小 0
    public static final byte MESSAGE_HEAD_OPTION_LINE_MAX_VALUE = (byte)(~(-1 << MESSAGE_HEAD_OPTION_LINE_BIT_SIZE)); // line 最大 00000111
    ...
    public static void main(String[] args) {
        System.out.println(DATA_PACK_OPTION_PONG);
        System.out.println((DATA_PACK_OPTION_PONG & DATA_PACK_OPTION_PONG) == DATA_PACK_OPTION_PONG);

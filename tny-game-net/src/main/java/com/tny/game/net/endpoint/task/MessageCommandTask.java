 ...
 */
public class MessageCommandTask<UID> implements CommandTask {
    ...
    public MessageCommandTask(NetTunnel<UID> tunnel, Message message, MessageDispatcher messageDispatcher) {

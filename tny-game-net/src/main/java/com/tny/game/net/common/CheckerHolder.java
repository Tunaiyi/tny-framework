...
public class CheckerHolder {
    ...
    @SuppressWarnings("unchecked")
    public ResultCode check(Session session, Message message, AppContext context) {
        ...
        ResultCode code = checker.check(session, message, this.controller, context, attributes);

 ...
 */
public interface RelayPipe<UID> {
	 ...
	 */
	@Nullable
	RelayTubule<UID> getTubule(long tunnelId);
	 ...
	 */
	RelayTubule<UID> closeTubule(long tunnelId);
	 ...
	 */
	RelayTubule<UID> connectTubule(long tunnelId, String remoteHost, int remotePort) throws PipeClosedException;
	//    /**
	//     * 接收数据包
	//     */

...
public final class ClassControllerHolder extends ControllerHolder {
    ...
    public ClassControllerHolder(final Object executor, final PluginHolder pluginHolder) {
    ...
    protected void initMethodHolder(final Object executor) {
        ...
        for (GMethod method : access.getGMethodList()) {
            ...
            if (controller == null)
                continue;
            MethodControllerHolder holder = new MethodControllerHolder(executor, this, method, controller, this.pluginHolder);
            if (holder.getID() > 0) {

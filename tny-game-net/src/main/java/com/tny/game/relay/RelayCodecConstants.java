...
public class RelayCodecConstants {
	 ...
	 * 转播连接打开
	 */
	public static final byte RELAY_PACKET_TYPE_LINK_OPEN = (byte)1;

	/**
	 * 转播连接关闭
	 */
	public static final byte RELAY_PACKET_TYPE_LINK_CLOSE = (byte)2;

	/**
	 * 转播连接ping
	 */
	public static final byte RELAY_PACKET_TYPE_LINK_PING = (byte)3;

	/**
	 * 转播连接ping
	 */
	public static final byte RELAY_PACKET_TYPE_LINK_PONG = (byte)4;
	 ...
	 * 转播通道断开
	 */
	public static final byte RELAY_PACKET_TYPE_TUNNEL_DISCONNECT = RELAY_PACKET_FOR_TUNNEL | (byte)2;

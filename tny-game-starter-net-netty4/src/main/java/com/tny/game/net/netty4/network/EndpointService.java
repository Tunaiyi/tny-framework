...
public class EndpointService {
     ...
     * @param body       消息体
     */
    public void push2User(String userType, Messager user, Protocol protocol, ResultCode resultCode, Object body) {
        Optional<EndpointKeeper<Object, Endpoint<Object>>> keeperOpt = this.endpointKeeperManager.getKeeper(userType);
        keeperOpt.ifPresent(k -> k.send2User(user.getIdentity(), toPush(protocol, resultCode, body)));
    }
     ...
     * @param body     消息体
     */
    public void push2User(String userType, Messager user, Protocol protocol, Object body) {
     ...
     * @param protocol 协议
     */
    public void push2User(String userType, Messager user, Protocol protocol, RpcResult<?> message) {
     ...
     * @param body       消息体
     */
    public void push2User(String userType, Messager user, ResultCode resultCode, Object body) {
     ...
     * @param body     消息体
     */
    public void push2User(String userType, Messager user, Object body) {
     ...
     * @param user     可标识用户的对象
     */
    public void push2User(String userType, Messager user, RpcResult<?> message) {
     ...
     * @param body       消息体
     */
    public void push2Users(String userType, Stream<? extends Messager> users, Protocol protocol, ResultCode resultCode, Object body) {
        Optional<EndpointKeeper<Object, Endpoint<Object>>> keeperOpt = this.endpointKeeperManager.getKeeper(userType);
        keeperOpt.ifPresent(k -> k.send2Users(users.map(Messager::getIdentity), toPush(protocol, resultCode, body)));
    }
     ...
     * @param body     消息体
     */
    public void push2Users(String userType, Stream<? extends Messager> users, Protocol protocol, Object body) {
     ...
     * @param protocol 协议
     */
    public void push2Users(String userType, Stream<? extends Messager> users, Protocol protocol, RpcResult<?> message) {
     ...
     * @param body       消息体
     */
    public void push2Users(String userType, Stream<? extends Messager> users, ResultCode resultCode, Object body) {
     ...
     * @param body     消息体
     */
    public void push2Users(String userType, Stream<? extends Messager> users, Object body) {
     ...
     * @param users    用户流
     */
    public void push2Users(String userType, Stream<? extends Messager> users, RpcResult<?> message) {

...
public class LocalNum<N extends Number> extends Number {
    ...
    public N add(LocalNum<?> num) {
        return this.number = NumberUtils.as(NumberUtils.add(this.number, num.number), this.number);
    }
    ...
    public N sub(LocalNum<?> num) {
        return this.number = NumberUtils.as(NumberUtils.sub(this.number, num.number), this.number);
    }
    ...
    public N multiply(LocalNum<?> num) {
        return this.number = NumberUtils.as(NumberUtils.multiply(this.number, num.number), this.number);
    }
    ...
    public N divide(LocalNum<?> num) {
        return this.number = NumberUtils.as(NumberUtils.divide(this.number, num.number), this.number);
    }
    ...
    public N mod(LocalNum<?> num) {
        return this.number = NumberUtils.as(NumberUtils.mod(this.number, num.number), this.number);
    }

...
public class LocalNum<N extends Number> extends Number {
    ...
    public N add(int num) {
        ...
        return number = NumberUtils.changeAs(value, this.number);
    }
    ...
    public N add(LocalNum<?> num) {
        return this.number = NumberUtils.changeAs(NumberUtils.add(this.number, num.number), this.number);
    }
    ...
    public N sub(LocalNum<?> num) {
        return this.number = NumberUtils.changeAs(NumberUtils.sub(this.number, num.number), this.number);
    }
    ...
    public N multiply(LocalNum<?> num) {
        return this.number = NumberUtils.changeAs(NumberUtils.multiply(this.number, num.number), this.number);
    }
    ...
    public N divide(LocalNum<?> num) {
        return this.number = NumberUtils.changeAs(NumberUtils.divide(this.number, num.number), this.number);
    }
    ...
    public N mod(LocalNum<?> num) {
        return this.number = NumberUtils.changeAs(NumberUtils.mod(this.number, num.number), this.number);
    }

...
public class EnumAide extends EnumUtils {
    ...
    public static <I, E extends EnumIdentifiable<I>, S> E of(Class<E> enumClass, Function<E, S> getter, S value) {
        return Throws.checkNotNull(uncheckOf(enumClass, getter, value),
                "{} 为 {} 的 {} 枚举实例不存在", getter, value, enumClass);
    }

    public static <I, E extends EnumIdentifiable<I>, S> E uncheckOf(Class<E> enumClass, Function<E, S> getter, S value) {

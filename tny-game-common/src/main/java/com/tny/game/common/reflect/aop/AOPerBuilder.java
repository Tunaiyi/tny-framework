...
public class AOPerBuilder<T> {
    ...
    private final static ConcurrentMap<Class<?>, Class<?>> AOPER_MAP = new ConcurrentHashMap<Class<?>, Class<?>>();
    ...
    private Set<Class<? extends Annotation>> aopAnnotationSet = new HashSet<Class<? extends Annotation>>();

    public static <C> AOPerBuilder<C> newBuilder(Class<C> clazz) {
        return new AOPerBuilder<C>(clazz);
    }

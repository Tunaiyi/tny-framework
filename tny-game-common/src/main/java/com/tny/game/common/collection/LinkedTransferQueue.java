...
/**
 * An unbounded {@link BlockingQueue} based on linked nodes. This queue orders
 ...
 * @version $Rev: 2373 $, $Date: 2010-10-20 20:33:23 +0900 (Wed, 20 Oct 2010) $
 *          (Upstream: 1.79)
 */
public class LinkedTransferQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
	 ...
	 * http://people.csail.mit.edu/edya/publications
	 * /OptimisticFIFOQueue-journal.pdf). However, the nature of dual queues
	 * enables a simpler tactic for improving M&S-style implementations when
	 * dual-ness is needed.
	 *
	 ...
	 * underdefined specs, we assume that might it help, and will not hurt in
    ...
    static final class Node {
         ...
         * after matching or cancelling. Uses relaxed writes bacause order is
     ...
     * @param pred  the predecessor of s, or s itself if it has no predecessor, or
    ...
    final class Itr implements Iterator<E> {
        /**
         * @uml.property name="nextNode"
         * @uml.associationEnd
         */
        private Node nextNode; // next node to return item for
        private E nextItem; // the corresponding item
        /**
         * @uml.property name="lastRet"
         * @uml.associationEnd
         */
        private Node lastRet; // last returned node, to support remove
        /**
         * @uml.property name="lastPred"
         * @uml.associationEnd
         */
    ...
    /**
     * Reconstitutes the Queue instance from a stream (that is, deserializes
     * it).
     *
     * @param s the stream
     */

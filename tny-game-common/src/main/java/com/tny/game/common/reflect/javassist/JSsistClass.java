...
public class JSsistClass implements GClass {
    ...
    public JSsistClass(Class<?> javaClass, MethodFilter filter) {
        ...
        for (Method method : methods) {
            ...
            JSsistMethod glibMethod = new JSsistMethod(method, methodInvoker);
        ...
        for (Entry<String, JSsistPropertyAccessor> entry : accessorMap.entrySet()) {
    ...
    public List<GMethod> getGMethodList() {
        return new ArrayList<GMethod>(this.methodMap.values());
    }
    ...
    public GPropertyAccessor getProperty(String name, Class<?> clazz) {
        GPropertyAccessor accessor = this.accessorMap.get(name);
    ...
    public GMethod getMethod(String name, Class<?>... parameterTypes) {
        for (GMethod method : this.methodMap.values()) {

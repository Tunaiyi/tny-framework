 ...
 */
public class Protobuf2CouchDBFormat extends Protobuf2JsonFormat {
    ...
    protected static class Tokenizer extends Protobuf2JsonFormat.Tokenizer {
    ...
    protected static class CouchDBGenerator extends Protobuf2JsonFormat.JsonGenerator {

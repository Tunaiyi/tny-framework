...
public class NetPackV1Decoder extends NetPackV1Codec implements NetPackDecoder {

	private static final Logger LOGGER = LoggerFactory.getLogger(NetPackV1Decoder.class);

	public NetPackV1Decoder(DataPacketCodecSetting config) {
		super(config);
	}

	public NetPackV1Decoder() {
	}
	...
	@Override
	public Message decodeObject(ChannelHandlerContext ctx, ByteBuf in, NetPackDecodeMarker marker) throws Exception {

 ...
 */
public class WriteMessageListenerHolder {

    public static final Logger LOGGER = LoggerFactory.getLogger(WriteMessageListenerHolder.class);
    ...
    public void fireListener(WriteMessageListener listener, WriteMessageFuture future) {
        try {

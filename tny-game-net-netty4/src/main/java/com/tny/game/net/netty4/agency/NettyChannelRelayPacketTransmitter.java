 ...
 */
public class NettyChannelRelayPacketTransmitter extends NettyChannelConnection implements RelayPacketTransmitter {

    public static final Logger LOGGER = LoggerFactory.getLogger(NettyChannelTransporter.class);

    public NettyChannelRelayPacketTransmitter(Channel channel) {
        super(channel);
    }

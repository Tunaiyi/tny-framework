...
public class NetDecoderHandler extends ByteToMessageDecoder {

	private static final Logger LOG = LoggerFactory.getLogger(NetLogger.DISPATCHER);

	private final NetPackDecoder decoder;

	private final NetPackDecodeMarker marker = new NetPackDecodeMarker();

	private boolean closeOnDecodeException = true;

	public NetDecoderHandler(NetPackDecoder decoder) {

...
//     }
//
//     protected TestNettyClientTunnel createLoginTunnel(BiFunction<Boolean, Tunnel<Long>, MessageContext<Long>> loginContentCreator) {
...
//     }
//
//     protected TestNettyClientTunnel createUnloginTunnel(BiFunction<Boolean, Tunnel<Long>, MessageContext<Long>> loginContentCreator) {
...
//     }
//
//     protected TestNettyClientTunnel createUnloginTunnel(SessionFactory<Long> sessionFactory, MessageBuilderFactory<Long> messageBuilderFactory, BiFunction<Boolean, Tunnel<Long>, MessageContext<Long>> loginContentCreator) {
...
//
//         public TestNettyClientTunnel(URL url, Channel channel, AppConfiguration configuration, BiFunction<Boolean, Tunnel<Long>, MessageContext<Long>> loginContentCreator) {
//             super(url, channel, configuration, loginContentCreator);
//         }
//
//         public TestNettyClientTunnel(URL url, Channel channel, Config config, SessionFactory<Long> sessionFactory, MessageBuilderFactory<Long> messageBuilderFactory, BiFunction<Boolean, Tunnel<Long>, MessageContext<Long>> loginContentCreator) {
//             super(url, channel, config, sessionFactory, messageBuilderFactory, loginContentCreator);
//         }
//
//
//         public TestNettyClientTunnel setLoginContentCreator(BiFunction<Boolean, Tunnel<Long>, MessageContext<Long>> loginContentCreator) {

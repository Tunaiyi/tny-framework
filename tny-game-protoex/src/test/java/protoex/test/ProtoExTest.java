...
class ProtoExTest {
    ...
    void testAll() {
        byte[] data;
        try (ProtoExWriter writer = this.createWrite()) {
        ...
        try (ProtoExReader reader = this.createReader(data)) {
    ...
    @Test
    void writeMessageWithCollection() {

        byte[] data;
        Collection<Object> readMessage;
        ...
        System.out.println(data.length);
        try (ProtoExReader reader = this.createReader(data)) {
            readMessage = reader.readMessage();
        }
    ...
    @Test
    void testMixUnpackedExplicitCollectionReadMessage() {
    ...
    @Test
    void testMixUnpackedImplicitCollection() {
    ...
    @Test
    void testMixPackedExplicitCollection() {
    ...
    @Test
    void testMixPackedImplicitCollection() {

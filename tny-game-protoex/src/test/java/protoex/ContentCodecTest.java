...
public class ContentCodecTest {
    ...
    private void testPerformance(Type type, Object instance) {
        ...
        String message = LogUtils.format("格式化{}大小:{},{}", type.getTypeName(), data.length, Arrays.toString(data));
        ...
        System.out.println(LogUtils.format("编码{}次一共消耗{}毫秒.", times, System.currentTimeMillis() - now.toEpochMilli()));
        ...
        System.out.println(LogUtils.format("解码{}次一共消耗{}毫秒.", times, System.currentTimeMillis() - now.toEpochMilli()));
    }
    ...
    public void testPerformance() {
        ...
        String message = LogUtils.format("[ProtoEx]编解码性能测试");
        System.out.println(message);

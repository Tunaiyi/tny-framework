...
public class TryUtils {
     ...
     * @return 返回结果
     */
    public static <M, MC extends M> TryDone<M> fail(MC value, TryToDoResult result) {
     ...
     * @return 返
     */
    public static <M, MC extends M> TryDone<MC> fail(MC value, TryDone<?> result) {
        ExceptionUtils.checkArgument(result.isFail(), "code [{}] is success", result.getCode());
        if (result.isTryFailed())

 ...
 * @author KGTny
 */
public abstract class AbstractCountableStuffStorage<IM extends ItemModel, SM extends CountableStuffModel, S extends BaseCountableStuff<SM, ?>>
        extends StuffStorage<IM, SM, S> {
